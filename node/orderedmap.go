...
//
// This is why the compact JSON renderer (MarshalNode, JSONEscape) lives in this
// package rather than in codec/json: a method must be declared in its receiver
// type's package, and codec/json already imports node, so the renderer sitting
// there would make the import graph circular.
